...
ofname="./inp/base/set_basic_filenames.inp"
...
input_ROOTfilePattern=${PWD}"/ROOTfiles/coin_replay_deep_check_%d_-1.root"
input_REPORTPattern=${PWD}"/REPORT_OUTPUT/replay_coin_deep_check_%d_-1.report"
