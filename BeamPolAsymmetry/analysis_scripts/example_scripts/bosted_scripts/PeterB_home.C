...
"/w/hallc-scifs17exp/c-sidis18/bosted/Skimfiles//Skimp" ;
 ...
 fileNameD += "coin_replay_production_"; //read the root file from data
  ...
  //fileNameD += "_10000.root"; //read the root file from data
  ...
  Double_t  hncombo2[10000],pncombo2[10000] ;
  ...
  // printf("%8.2f %8.2f\n",HhodoStartTimeMean, PhodoStartTimeMean) ;
    ...
    if(kk<0 && pdelta<99.) printf("%6.1f %6.1f\n",pbeta,hbeta) ;
...
// Get helicity: different for sping18 and later
    if(runNumber <  5300) {
   	  helmpsi = 0 ;
...
// Define raw coincidence time
    ...
    if( 
      ...
      if(hdelta > 12. && hdelta < 12. ) {
         printf("hms 32! %d %.2f %.2f %.2f \n",nevntall,HhodStartTime,
...
// Set flags to define good times. This is includes having a valid track.
    goodsch = 0. ;
    if(HhodfpHitsTime > 0. && 
       HhodfpHitsTime < 99. &&
       hdelta>-99. && hdelta<99. &&
...
// Coin time using start times
	 ...
	 ctpi4 = ctpi4 - 135. ;
       ...
       if(ctpi1 > -50. && ctpi1 < 100 && kk<400 && kk>400) 
	 printf(
        "ct %6.1f %6.1f %6.1f %6.1f %6.1f %6.1f \n",
        hpst,t41,ctpi1,ctpi2,ctimepi,ctimeK) ; 
       //        (t11 - t41 - (t12 - t42))) ;
       //       printf("%8.2f %8.2f\n",ctimepi,pbeta) ;
...
// Electron in HMS
	...
	fprintf(f2,
"%6.2f %5.2f %5.2f %1d %1d %1d %6.2f %7.4f %7.4f %6.2f %7.4f %7.4f %4.1f %4.2f %4.2f %4.1f %4.1f %4.1f %4.2f %4.2f %5.1f %5.1f %6.3f %6.2f %7.4f %6.2f %7.4f %6.2f %7.4f %6.2f %7.4f %8.2f %8.2f %8.2f %8.2f %8.2f %8.2f %8.2f %1d %1d %.3f %.2f\n",
...
//	    (int)helmpsa,(int)helnega,(int)helposa,hdelta,HgtrTh,
	   ...
	   hdcx,hdcxp,hdcy,hdcyp,pdcx,pdcxp,pdcy,pdcyp,prf,hrf,
		...
		goodsch,goodscp,hbeta,ctimepinew) ;
...
// Electron in SHMS
	...
	fprintf(f3,
"%6.2f %5.2f %5.2f %1d %1d %1d %6.2f %7.4f %7.4f %6.2f %7.4f %7.4f %4.1f %4.2f %4.2f %4.1f %4.1f %4.1f %4.2f %4.2f %5.1f %5.1f %6.3f %6.2f %6.3f %6.2f %6.3f %6.2f %6.3f %6.2f %6.3f %8.2f %8.2f %8.2f %8.2f %8.2f %8.2f %8.2f\n",
	   ctimepi,ctimeK-ctimepi,ctimep-ctimepi,
//	    (int)helmpsa,(int)helnega,(int)helposa,hdelta,HgtrTh,
	   (int)hel1+1,(int)helrep+1,(int)helmps+1,hdelta,HgtrTh,
           HgtrPh,pdelta,PgtrTh,PgtrPh,hcernpe,
	   ...
	   paeronpe,pcernpe,pcalepr,pcaletot,hgtry,pgtry,pbeta,
	   hdcx,hdcxp,hdcy,hdcyp,pdcx,pdcxp,pdcy,pdcyp,prf,hrf,
		 PhodfpHitsTime,HhodfpHitsTime,pztar,hztar,ctpi1) ;
       } // cointime check
      } // delta, PID cut
    } //wide pdelta check
