...
int main()
{
  ...
  */
  ...
  run_list       = trim(split(FindString("run_list", "main_controls_KaonLT.inp")[0], '=')[1]);
  analysis_type  = trim(split(FindString("analysis_type", "main_controls_KaonLT.inp")[0], '=')[1]);
  electron_arm   = trim(split(FindString("electron_arm", "main_controls_KaonLT.inp")[0], '=')[1]);
  daq_mode       = trim(split(FindString("daq_mode", "main_controls_KaonLT.inp")[0], '=')[1]);
  helicity_flag       = stoi(split(FindString("helicity", "main_controls_KaonLT.inp")[0], '=')[1]);
